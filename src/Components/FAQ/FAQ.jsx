    ...
    return (
        <MDBContainer className="mt-2">
            <section>
                <MDBTypography
                    tag="h3"
                    className="text-center mb-4 pb-2 textPrimary fw-bold"
                >
                    FAQ
                </MDBTypography>
                ...
                <MDBRow>
                    <MDBCol md="6" lg="4" className="mb-4">
                        <MDBTypography tag="h6" className="mb-3 textPrimary">
                            <MDBIcon far icon="paper-plane textPrimary pe-2" /> A simple
                            question?
                        </MDBTypography>
                        <p>
                            <strong>
                    ...
                    <MDBCol md="6" lg="4" className="mb-4">
                        <MDBTypography tag="h6" className="mb-3 textPrimary">
                            <MDBIcon fas icon="pen-alt textPrimary pe-2" /> A question that
                    ...
                    <MDBCol md="6" lg="4" className="mb-4">
                        <MDBTypography tag="h6" className="mb-3 textPrimary">
                            <MDBIcon fas icon="user textPrimary pe-2" /> A simple question?
                        </MDBTypography>
                        <p>
                    ...
                    <MDBCol md="6" lg="4" className="mb-4">
                        <MDBTypography tag="h6" className="mb-3 textPrimary">
                            <MDBIcon fas icon="rocket textPrimary pe-2" /> A simple question?
                        </MDBTypography>
                        <p>
                    ...
                    <MDBCol md="6" lg="4" className="mb-4">
                        <MDBTypography tag="h6" className="mb-3 textPrimary">
                            <MDBIcon fas icon="home textPrimary pe-2" /> A simple question?
                        </MDBTypography>
                        <p>
                            <strong>
                    ...
                    <MDBCol md="6" lg="4" className="mb-4">
                        <MDBTypography tag="h6" className="mb-3 textPrimary">
                            <MDBIcon fas icon="book-open textPrimary pe-2" /> Another
